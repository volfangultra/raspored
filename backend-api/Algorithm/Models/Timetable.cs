...
{
    public List<ProfessorAlgo> Professors { get; set; }

    public List<StudyGroupAlgo> StudyGroups { get; set; }

    public List<LessonAlgo> Lessons { get; set; }

    public List<KeyValuePair<short, short>> Timeslots { get; set; }

    public Timetable() { }

    public Timetable(
        List<StudyGroupContract> studyGroups,
        List<ProfessorContract> professors,
        List<LessonContract> lessons,
        List<StudyGroupAssignedLessonContract> studyGroupAssignedTeachingGroups,
        List<ProfessorAssignedLessonContract> professorAssignedTeachingGroups,
        List<TimeslotsContract> timeslots)
    {
        Check(studyGroups, professors, lessons, studyGroupAssignedTeachingGroups, professorAssignedTeachingGroups, timeslots);
    ...
    {
        if (!classAssignedTeachingGroups.All(x => studyGroups.Any(c => c.Id == x.IdClass)))
        {
    ...
    private List<Class> TransformClasses(List<StudyGroupContract> classes, List<ClassAssignedTeachingGroupContract> classAssignedTeachingGroups)
    {
