...
const Courses = ({handleStudentGroupSelect, handleProfessorSelect, handleClassroomSelect, allClassrooms, allCourses, courses, professor, studentGroup, classroom}) => {
  ...
  return (
    <div style={{ display: 'flex', gap: '20px', marginTop: '20px' }}>
      ...
      <ScheduleTable handleClassroomSelect={handleClassroomSelect} handleProfessorSelect={handleProfessorSelect} handleStudentGroupSelect={handleStudentGroupSelect} content={content} onDrop={handleDrop} professor={professor} studentGroup={studentGroup} classroom={classroom} courses={courses} allCourses={allCourses} allClassrooms={allClassrooms}/>
    </div>
  );
};
